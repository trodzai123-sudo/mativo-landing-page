...
Trang ưu tiên trải nghiệm xem sản phẩm: ảnh trọn bộ xuất hiện ngay tại hero, banner so sánh hai phiên bản, hai thư viện tương tác riêng cho X24/X36 và khối “Bộ sản phẩm” liệt kê rõ từng thành phần của X24.
